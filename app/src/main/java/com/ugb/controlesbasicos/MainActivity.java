...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // De aqui comienza lo que coloque sobre el area del telefono CountryCodePicker
    ...
    private void actualizarPrefijoTelefono() {
        // Obtener el prefijo telefónico del país seleccionado
        String countryCode = countryCodePicker.getSelectedCountryNameCode();
        int countryCodePrefix = PhoneNumberUtil.getInstance().getCountryCodeForRegion(countryCode);

        // Actualizar el campo de teléfono con el prefijo telefónico
        EditText txtTelefono = findViewById(R.id.txtTelefono);
        String phoneNumber = txtTelefono.getText().toString();
        String formattedPhoneNumber = "+" + countryCodePrefix + phoneNumber;
        txtTelefono.setText(formattedPhoneNumber);
    }
